...
const defaultClinicSettings = {
  ...
  logoUrl: "assets/logo.jpg?v=25",
  stampUrl: "assets/stamp.jpg?v=25",
  signatureUrl: "assets/signature.png?v=25",
  phone: "01001097896",
...
function openPatientActionsModal(patientId) {
  ...
  grid.innerHTML = `
    ...
    <button class="btn btn-amber" onclick="closePatientActionsModal(); switchTab('schedule-tab', document.querySelectorAll('.tab-btn')[2]);">📅 حجز متابعة</button>
